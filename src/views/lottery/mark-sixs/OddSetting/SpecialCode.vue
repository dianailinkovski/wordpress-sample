<template>
  ...
  <el-row>
    <el-form-item label="赔率" style="margin-right: 10px;">
      <el-input type="number" v-model="bl" />
    </el-form-item>
    <el-button @click="onSave" >统一修改</el-button>
  </el-row>
  <!-- <h1>Welcome to my {{ img_dis }}</h1> -->
</template>
<script setup>
import { ref, reactive,computed } from 'vue'

const img_dis= computed(()=>{
  // const img_url=reactive()
  return "./number/num1.gif"
})
